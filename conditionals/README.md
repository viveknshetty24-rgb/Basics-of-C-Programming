...
This folder contains basic C programs that demonstrate conditional statements.
...
- `vote_eligibility.c` – checks whether a person is eligible to vote or not , based on the age of the person using if-else condition.
